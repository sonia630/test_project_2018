...
##### 代码地址为：[SparkPi](/com/examples/JavaSparkPi.java)
...
##### 代码地址为: [JavaBroadcastTest](/com/examples/JavaBroadcastTest.java)
...
##### 代码地址为: [JavaAccumulatorTest](/com/examples/JavaAccumulatorTest.java)
...
#### 1. 读取本地文件: [JavaLocalFileTest](/com/examples/JavaLocalFileTest.java)
...
#### 2. 读写文本文件的例子(从本地读取写入到 HDFS 上): [JavaHdfsFileTest](/com/examples/JavaHdfsFileTest.java)
...
#### 3. 读写 JSON 文件的例子: [JavaJsonTest](/com/examples/JavaJsonTest.java)
...
#### 4. 读取 CSV 文件的例子: [JavaParseCsvTest](/com/examples/JavaParseCsvTest.java)
...
#### 5. 读取 SequenceFiles 文件的例子: [JavaParseSequenceFiles](/com/examples/JavaParseSequenceFiles.java)
...
### 示例 5: 使用 JDBC 接口 [JavaJdbcTest](/com/examples/JavaJdbcTest.java)
...
##### 代码地址为: [JavaSparkSQL](/com/examples/sql/JavaSparkSQL.java)
...
#### 1 Kafka 单词计数 [JavaKafkaWordCount](/com/examples/streaming/JavaKafkaWordCount.java)
...
#### 2 Kafka 单词计数-Direct 接口版本 [JavaDirectKafkaWordCount](/com/examples/streaming/JavaDirectKafkaWordCount.java)
...
#### 3 网络发送单词的计数问题 [JavaNetworkWordCount](/com/examples/streaming/JavaNetworkWordCount.java)
...
#### 4 网络发送单词的计数问题-CheckPoint版本 [JavaRecoverableNetworkWordCount](/com/examples/streaming/JavaRecoverableNetworkWordCount.java)
...
#### 5 网络发送单词的计数问题-SQL版本 [JavaSqlNetworkWordCount](/com/examples/streaming/JavaSqlNetworkWordCount.java)
